...
function webRTCEndpointCallback(error, callerWebRtcEndpoint) {
    if (error) {
        pipeline.release();
...
function mediaPipeLineCallback(error, pipeline) {
    if (error) {
        return callback(error);
    }

    pipeline.create('WebRtcEndpoint', webRTCEndpointCallback);
}
...
CallMediaPipeline.prototype.createPipeline = function(callerId, calleeId, ws, callback) {
    ...
    getKurentoClient(function(error, kurentoClient) {
        ...
        kurentoClient.create('MediaPipeline', mediaPipeLineCallback);
    })
}
